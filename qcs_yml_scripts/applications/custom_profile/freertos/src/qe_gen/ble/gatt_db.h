...
typedef enum
{
    ...
    BLE_QC_SVCS_DECL_HDL = 0x0010,
    BLE_QC_SVCS_QC_REQ_DECL_HDL = 0x0011,
    BLE_QC_SVCS_QC_REQ_VAL_HDL = 0x0012,
    BLE_QC_SVCS_QC_REQ_CHAR_USER_DESC_DESC_HDL = 0x0013,
    BLE_QC_SVCS_QC_RSP_DECL_HDL = 0x0014,
    BLE_QC_SVCS_QC_RSP_VAL_HDL = 0x0015,
    BLE_QC_SVCS_QC_RSP_CLI_CNFG_DESC_HDL = 0x0016,
    BLE_QC_SVCS_QC_RSP_CHAR_USER_DESC_DESC_HDL = 0x0017,
} e_ble_attr_hdl_t;
...
#define BLE_QC_SVCS_QC_REQ_LEN (32)
#define BLE_QC_SVCS_QC_REQ_CHAR_USER_DESC_LEN (100)
#define BLE_QC_SVCS_QC_RSP_LEN (101)
#define BLE_QC_SVCS_QC_RSP_CLI_CNFG_LEN (2)
#define BLE_QC_SVCS_QC_RSP_CHAR_USER_DESC_LEN (100)
