...
#define SENSOR_QUEUE_LENGTH (20U)
/******************************************************************************
...
uint8_t g_sensor_queue_queue_memory[SENSOR_QUEUE_LENGTH * SENSOR_DATA_COUNT * sizeof(float)];
...
void sensor_thread_entry(void *pvParameters)
{
    ...
    g_sensor_queue = xQueueCreateStatic ( SENSOR_QUEUE_LENGTH, SENSOR_DATA_COUNT * sizeof(float), &g_sensor_queue_queue_memory[0], &g_sensor_queue_memory);
