...
/*******************************************************************************************************************//**
 * @brief       Get a handle for a sensor of a specific type. This function makes use of an internal variable
 *              to keep track of the sensor indexing. Each call returns the next handle for that sensor type
