...
typedef enum qe_attribute_handle
{
	...
	QE_ATTRIBUTE_HANDLE_SERVICE_DECL_QC_SVC,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_QC_SVC_QC_REQ,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_QC_SVC_QC_REQ,
	QE_ATTRIBUTE_HANDLE_DESCRIPTOR_QC_SVC_QC_REQ_CHAR_USER_DESC,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_DECL_QC_SVC_QC_RSP,
	QE_ATTRIBUTE_HANDLE_CHARACTERISTIC_VALUE_QC_SVC_QC_RSP,
	QE_ATTRIBUTE_HANDLE_DESCRIPTOR_QC_SVC_QC_RSP_CLI_CNFG,
	QE_ATTRIBUTE_HANDLE_DESCRIPTOR_QC_SVC_QC_RSP_CHAR_USER_DESC,
...
#define		QE_BLE_PROFILE_NUMBER_OF_ATTRIBUTES	(0x0018)
